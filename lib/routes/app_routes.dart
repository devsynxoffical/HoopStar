...
import 'package:courtiq/features/auth/forgotpassword/view/password_reset_success_screen.dart';
import 'package:courtiq/features/auth/view/auth_screen.dart';
import 'package:courtiq/features/auth/view/registration_success_screen.dart';
...
class AppRoutes {
  static Route<dynamic> generate(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case RouteNames.registration_success:
        return MaterialPageRoute(builder: (_) => RegistrationSuccessScreen(role: role));
      case RouteNames.password_reset_success:
